...
set AVEVA_DESIGN_DFLTS=%CP_DEVELOPMENT_PATH%\data\dflts\;%TP_DEVELOPMENT_PATH%\data\dflts\;%AVEVA_DESIGN_INSTALLED_DIR%\data\dflts\
:: set AVEVA_DESIGN_PLOTS=%CP_DEVELOPMENT_PATH%\PMLUI\plots;%AVEVA_DESIGN_INSTALLED_DIR%\pmlui\plots\

set CAF_ADDINS_PATH=%AVEVA_DESIGN_INSTALLED_DIR%\;%CP_DEVELOPMENT_PATH%\dlls\;%TP_DEVELOPMENT_PATH%\dlls\
set CAF_UIC_PATH=%AVEVA_DESIGN_INSTALLED_DIR%\;%CP_DEVELOPMENT_PATH%\uic\;%TP_DEVELOPMENT_PATH%\uic\
...
set PDMSDFLTS=%AVEVA_DESIGN_INSTALLED_DIR%\data\dflts\;%CP_DEVELOPMENT_PATH%\data\dflts\;%TP_DEVELOPMENT_PATH%\data\dflts\
:: set PDMSPLOTS=%CP_DEVELOPMENT_PATH%\PMLUI\plots;%AVEVA_DESIGN_INSTALLED_DIR%\pmlui\plots\
set PDMSUI=%AVEVA_DESIGN_INSTALLED_DIR%\pmlui\;%CP_DEVELOPMENT_PATH%\PMLUI\;%TP_DEVELOPMENT_PATH%\PMLUI\

set PMLLIB=%AVEVA_DESIGN_INSTALLED_DIR%\pmllib\;%CP_DEVELOPMENT_PATH%\pmllib\;%TP_DEVELOPMENT_PATH%\pmllib\
set PMLUI=%AVEVA_DESIGN_INSTALLED_DIR%\pmlui\;%CP_DEVELOPMENT_PATH%\pmlui\;%TP_DEVELOPMENT_PATH%\pmlui\
